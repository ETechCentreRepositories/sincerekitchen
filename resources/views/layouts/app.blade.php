...
<head>
    ...
    <script src="http://ehostingcentre.com/sincerekitchen/js/jquery.min.js"></script>
    <!-- <script src="http://ehostingcentre.com/sincerekitchen/js/sorttable.js"></script> -->
    <!-- CSRF Token -->
...
return confirm('THIS ACTION CANNOT REVERT BACK!\n\nAre you sure?');
}
function goBack() {
    window.history.back();
}
